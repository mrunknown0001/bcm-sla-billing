...
@section('scripts')
  ...
  <script>
    ...
    // Billing
    $(document).on('click', '#view_billing_bcm_mgr', function (e) {
        e.preventDefault();
        var id = $(this).data('id');
        var text = $(this).data('text');
        Swal.fire({
    ...
    $(document).on('click', '#approve_billing_bcm_mgr', function (e) {
        e.preventDefault();
        var id = $(this).data('id');
        var text = $(this).data('text');
        Swal.fire({
    ...
    $(document).on('click', '#disapprove_billing_bcm_mgr', function (e) {
        e.preventDefault();
        var id = $(this).data('id');
        var text = $(this).data('text');
        Swal.fire({
